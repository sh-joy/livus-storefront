  ...
  return (
    <div className="bg-[#f0f0f0] flex h-[137px] items-center justify-center overflow-hidden shrink-0 w-[120px]">
      <div className="relative" style={{ width: "116.17%", height: "100%" }}>
        <img alt="product" className="absolute h-full object-cover top-0" style={{ left: "-8.01%", width: "116.17%" }} src={imgImage114} />
      </div>
    </div>
  );
}
    ...
    <div className="flex gap-[16px] items-start w-full shrink-0">
      ...
      <div className="flex-1 flex flex-col justify-between py-[3px] self-stretch min-w-0">
        <div className="flex items-start justify-between w-full whitespace-nowrap leading-[24px] text-[#1c1c1c]">
          <div className="font-['Barlow_Semi_Condensed:Regular',sans-serif] flex flex-col items-start shrink-0">
            <p className="text-[18px] tracking-[-0.36px]">{name}</p>
            <p className="text-[17px] tracking-[-0.085px]">Color: {color}</p>
            <p className="text-[17px] tracking-[-0.085px]">Size: {size}</p>
          </div>
          <p className="font-['Barlow_Semi_Condensed:Medium',sans-serif] text-[18px] shrink-0">
            {price}
          </p>
        </div>
        <div className="flex items-center justify-between w-full shrink-0">
          <div className="flex gap-[16px] items-center">
            ...
            <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[20px] text-[17px] tracking-[-0.34px] text-[#1c1c1c]">
              {count}
            </p>
            <button
          ...
          <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[24px] text-[17px] tracking-[-0.085px] underline text-[#1c1c1c] cursor-pointer">
            Remove
          </p>
        </div>
      </div>
          ...
          >
            <div className="flex flex-col justify-between p-[20px] size-full">
              ...
              <div className="flex flex-col gap-[20px] items-start w-full">
                {/* Header */}
                <div className="flex items-center justify-between w-full shrink-0">
                  <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[28px] text-[22px] text-[#1a1a1a] whitespace-nowrap">
                    Cart
                  </p>
                  <div className="flex gap-[20px] items-center">
                    <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] text-[17px] tracking-[-0.085px] underline text-[#1c1c1c] cursor-pointer">
                      Clear All
                    </p>
              ...
              <div className="flex flex-col gap-[20px] items-start w-full shrink-0">
                <div className="flex items-center justify-between w-full text-[#1c1c1c] text-[22px] tracking-[-0.44px] leading-[24px] whitespace-nowrap">
                  <p className="font-['Barlow_Semi_Condensed:Medium',sans-serif]">Subtotal</p>
                  <p className="font-['Barlow_Semi_Condensed:Medium',sans-serif]">৳1689 BDT</p>
                </div>
                <div onClick={handleCheckout} className="bg-[#050505] w-full flex items-center justify-center px-[20px] py-[12px] cursor-pointer hover:opacity-90 transition-opacity">
                  <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[24px] text-[17px] text-white whitespace-nowrap">
                    Checkout
                  </p>
                </div>
              </div>
