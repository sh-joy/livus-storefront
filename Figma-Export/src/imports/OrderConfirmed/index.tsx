...
function Frame15() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-center relative shrink-0 text-[#1c1c1c] w-full">
      <p className="font-['Big_Shoulders_Display:SemiBold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[32px] whitespace-nowrap">Order Confirmed</p>
      <p className="font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[24px] min-w-full not-italic relative shrink-0 text-[18px] text-center w-[min-content]">Thank you for choosing LIVUS. Your products will arrive within 2-3 working days.</p>
    </div>
  );
}
...
function Frame189Status() {
  return (
    <div className="bg-[#050505] content-stretch flex items-center justify-center px-[20px] py-[12px] relative shrink-0" data-name="Frame 189/Status3">
      <p className="[word-break:break-word] font-['Barlow_Semi_Condensed:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[17px] text-white whitespace-nowrap">View my orders</p>
    </div>
  );
}
