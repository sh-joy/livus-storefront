    ...
    <div className="aspect-[700/700] bg-[#f0f0f0] justify-self-stretch overflow-clip relative shrink-0">
      <div className="absolute aspect-[949.88671875/1161.09765625] bottom-[-88.83px] left-[0.71%] right-[14.27%]" data-name="image 115">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[102.31%] left-0 max-w-none top-[-2.29%] w-full" src={typeof imgImage115 === 'string' ? imgImage115 : imgImage115?.src} />
        </div>
      </div>
    </div>
  );
...
function Frame36() {
  return (
    <div className="content-stretch flex font-['Barlow Semi Condensed:Regular','Noto_Sans_Bengali:Regular',sans-serif] gap-[8px] items-start leading-[24px] relative shrink-0">
      <p className="relative shrink-0 text-[#1c1c1c] text-[24px]" style={{ fontVariationSettings: '"wdth" 100, "wght" 400' }}>
        ৳899 BDT
      </p>
      <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid line-through relative shrink-0 text-[#666666] text-[18px] font-normal font-medium" style={{ fontVariationSettings: '"wdth" 100, "wght" 400' }}>{`৳1199 `}</p>
    </div>
  );
}
...
function Frame189Status() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full whitespace-nowrap" data-name="Frame 189/Status3">
      <p className="font-serif font-semibold leading-[32px] relative shrink-0 text-[#1c1c1c] text-[28px]">Oakwood Long sleeve</p>
      <Frame36 />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#1c1c1c] text-[17px] tracking-[-0.34px] whitespace-nowrap">Color: Black</p>
      <Frame41 />
    </div>
  );
}
...
function Frame189Status1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Frame 189/Status3">
      ...
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#1a1a1a] text-[17px] tracking-[0.17px] whitespace-nowrap">S</p>
    </div>
  );
}
...
function Frame189Status2() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Frame 189/Status3">
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#606060] text-[17px] tracking-[0.17px] whitespace-nowrap">M</p>
    </div>
  );
}
...
function Frame189Status3() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Frame 189/Status3">
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#606060] text-[17px] tracking-[0.17px] whitespace-nowrap">XL</p>
    </div>
  );
}
...
function Frame189Status4() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Frame 189/Status3">
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#606060] text-[17px] tracking-[0.17px] whitespace-nowrap">XXL</p>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[#1c1c1c] text-[17px] tracking-[-0.34px] whitespace-nowrap">Quantity</p>
      <Frame31 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Frame 189/Status3">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[20px] py-[12px] relative size-full">
          <p className="[word-break:break-word] font-sans leading-[24px] not-italic relative shrink-0 text-[17px] text-black whitespace-nowrap">Add to cart</p>
        </div>
      </div>
    </div>
  );
