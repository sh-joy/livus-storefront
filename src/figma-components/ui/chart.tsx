  ...
  (props, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8.75rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
      >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value && (
                        <span className="font-mono font-medium tab-nums text-foreground">
