...
function Row({ label, bold }: { label: string; bold?: boolean }) {
  return (
    <div className="content-stretch flex items-center justify-center py-[12px] relative shrink-0 w-full">
      ...
      <p className={`[word-break:break-word] flex-[1_0_0] ${bold ? "font-['Barlow_Semi_Condensed:Medium',sans-serif]" : "font-['Barlow_Semi_Condensed:Regular',sans-serif]"} leading-[24px] min-w-px not-italic relative text-[#1a1a1a] text-[17px] tracking-[-0.085px]`}>
        {label}
      </p>
    </div>
  );
...
function Cell({ value, bold }: { value: string; bold?: boolean }) {
  return (
    <div className="content-stretch flex items-center justify-center p-[12px] relative shrink-0">
      <div aria-hidden className="absolute border-[#e2e2e2] border-b border-solid inset-0 pointer-events-none" />
      <p className={`[word-break:break-word] ${bold ? "font-['Barlow_Semi_Condensed:Medium',sans-serif]" : "font-['Barlow_Semi_Condensed:Regular',sans-serif]"} leading-[24px] not-italic relative shrink-0 text-[#1a1a1a] text-[17px] tracking-[-0.085px] w-[40px]`}>
        {value}
      </p>
    </div>
  );
